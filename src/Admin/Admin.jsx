          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                "&:hover": {
                  bgcolor: location.pathname === item.link ? "#7c3aed" : "#f5f5f5",
                },
              }}
            >
  ...
  return (
    <div>
      <div className="flex h-[100vh] sticky top-0">
        ...
        {/* Sidebar */}
        <div className="w-[15%] border-r border-gray-300">{drawer}</div>

        {/* Nội dung bên phải */}
        <div className="w-[85%] overflow-auto bg-gray-50">
          <Routes>
