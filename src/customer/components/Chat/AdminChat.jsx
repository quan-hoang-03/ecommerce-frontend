...
const AdminChat = () => {
  ...
  return (
    <div className="fixed bottom-0 right-0 w-96 bg-white shadow-2xl rounded-t-lg flex flex-col z-50 border border-gray-200">
      {/* Header */}
        ...
        >
          ...
          >
            <path
              ...
              strokeWidth={2}
              d={isChatOpen ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"}
            />
          </svg>
        </button>
      </div>
      ...
      {isChatOpen ? (
        ...
        // Minimized - show unread count
        <div className="p-4 text-center">
          <p className="text-gray-600">
            {chat.unreadCount > 0
              ? `Có ${chat.unreadCount} tin nhắn chưa đọc`
