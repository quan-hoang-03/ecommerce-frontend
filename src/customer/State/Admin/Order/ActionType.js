...
// Các Action dành cho đơn hàng đã xác nhận
...
// Các Action dành cho đơn hàng đã đặt
...
// Các Action dành cho đơn hàng đã giao
...
// Các Action dành cho đơn hàng bị hủy
...
// Các Action dành cho việc xóa đơn hàng
export const DELETE_ORDER_REQUEST = 'DELETE_ORDER_REQUEST';
export const DELETE_ORDER_SUCCESS = 'DELETE_ORDER_SUCCESS';
export const DELETE_ORDER_FAILURE = 'DELETE_ORDER_FAILURE';

// Các Action dành cho đơn hàng đang được giao
