...
import { CANCELED_ORDER_FAILURE, CANCELED_ORDER_REQUEST, CANCELED_ORDER_SUCCESS, CONFIRMED_ORDER_FAILURE, CONFIRMED_ORDER_REQUEST, CONFIRMED_ORDER_SUCCESS, DELETE_ORDER_REQUEST, DELETE_ORDER_SUCCESS, DELIVERED_ORDER_FAILURE, DELIVERED_ORDER_REQUEST, DELIVERED_ORDER_SUCCESS } from "./ActionType";
...
export const confirmOrder = (orderId) => async (dispatch) => {
  ...
  try {
    const response = await api.post(`/api/admin/orders/${orderId}/confirmed`);
...
export const shipOrder = (orderId) => {
  return async (dispatch) => {
    try {
      ...
      const { data } = await api.post(`/api/admin/orders/${orderId}/ship`);
